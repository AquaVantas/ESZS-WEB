...
if (isset($_GET["article_id"])) {
    ...
    if (!$article) {
        header("HTTP/1.1 404 Article Not Found");
        die();
    }
...
<html>
    <head>
        <title>E-športna zveza Slovenije - Uredi Članek</title>
...
#editor-toolbar {
    ...
    <body>
        ...
        <center><div id="container">
            ...
            <label for="date">Datum: </label><input type="date" id="date" name="date" value="<?= $date ?>"><br>
