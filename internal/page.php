...
$article = news_db::getArticleByPage($_GET["page"]);

if (!$article) {
    // article_id not in database
    header("HTTP/1.1 403 Page Not Found");
    die();
}
?><!DOCTYPE html>
<html>
			...
			<div class="row">
				<div class="col-xxl-8 col-xl-8 col-lg-8" id="articletitle">
					<div class="newstitletext" style="width: 80%; padding: 40px;">
						<div class="newstitlepin" style="font-size: 30px; padding-bottom: 10px;"><?= $article["news_article_title"] ?></div>
