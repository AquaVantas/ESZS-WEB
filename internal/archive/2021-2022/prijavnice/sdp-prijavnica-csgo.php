			...
			<div class="row">
				...
				<div class="col-xxl-8 col-xl-8 col-lg-8" style="padding-bottom: 70px;">
					...
					<form method="post" action="submitCSGO.php"><br>
						...
						<label for="captainnickname">Steam ID: <span style="color: red;">*</span></label><br>
						<input type="text" id="captainnickname" name="captainnickname" placeholder="76561198024047348"><br>
						...
						<label for="player2nickname">Steam ID: <span style="color: red;">*</span></label><br>
						<input type="text" id="player2nickname" name="player2nickname" placeholder="76561198024047348" required><br>
						...
						<label for="player3nickname">Steam ID: <span style="color: red;">*</span></label><br>
						<input type="text" id="player3nickname" name="player3nickname" placeholder="76561198024047348" required><br>
						...
						<label for="player4nickname">Steam ID: <span style="color: red;">*</span></label><br>
						<input type="text" id="player4nickname" name="player4nickname" placeholder="76561198024047348" required><br>
						...
						<label for="player5nickname">Steam ID: <span style="color: red;">*</span></label><br>
						<input type="text" id="player5nickname" name="player5nickname" placeholder="76561198024047348" required><br>
						...
						<label for="player6nickname">Steam ID: </label><br>
						<input type="text" id="player6nickname" name="player6nickname" placeholder="76561198024047348"><br>
						...
						<label for="player7nickname">Steam ID: </label><br>
						<input type="text" id="player7nickname" name="player7nickname" placeholder="76561198024047348"><br>
