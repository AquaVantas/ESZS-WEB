		...
		<div class="container" style="padding-top: 50px;">
			<div class="row">
				...
				<div class="col-xxl-8 col-xl-8 col-lg-8" style="padding-bottom: 70px;">
					...
					<br><br><br>
					<h1>Prijavnica na SDP ROCKET LEAGUE</h1>
					Polja označena z <span style="color: red;">*</span> so obvezna!
					
					
					<form method="post" action="submitRLPrijavnica.php"><br>
						<label for="team"><span style="font-size: 23px; font-weight: bold;">IME EKIPE:</span> <span style="color: red;">*</span></label><br>
						<input type="text" id="team" name="team" placeholder="car_goes_VROOOOOOM" required><br><br><br>
						...
						<input type="text" id="captainnickname" name="captainnickname" placeholder="KawaiiJanez"><br>
						...
						<input type="text" id="player2nickname" name="player2nickname" placeholder="KawaiiJanez" required><br>
						...
						<input type="text" id="player3nickname" name="player3nickname" placeholder="KawaiiJanez" required><br>
						...
						<table width="100%">
							<tr>
								<td style="padding-right: 10px;">
									<label for="player4name">Ime:</label><br>
									<input type="text" id="player4name" name="player4name" placeholder="Janez"><br>
								</td>
								<td style="padding-left: 10px;">
									<label for="player4surname">Priimek:</label><br>
									<input type="text" id="player4surname" name="player4surname" placeholder="Novak"><br>
								</td>
							<tr>
						</table>
						<label for="player4email">Email:</label><br>
						<input type="text" id="player4email" name="player4email" placeholder="janez.novak@nekmail.com"><br>
						<label for="player4discord">Discord:</label><br>
						<input type="text" id="player4discord" name="player4discord" placeholder="janci#0420"><br>
						<label for="player4nickname">Vzdevek v igri:</label><br>
						<input type="text" id="player4nickname" name="player4nickname" placeholder="KawaiiJanez"><br>
						<label for="player4drzavljanstvo">Državljanstvo:</label><br>
						<input type="text" id="player4drzavljanstvo" name="player4drzavljanstvo" placeholder="slovensko"><br><br><br>
						<table width="100%">
							<tr>
