			...
			<div class="row">
				...
				<div class="col-xxl-8 col-xl-8 col-lg-8" style="padding-bottom: 70px;">
					...
					<form method="post" action="submitValorant.php"><br>
						...
						<input type="text" id="captainnickname" name="captainnickname" placeholder="JanezekV38#1234"><br>
						...
						<input type="text" id="player2nickname" name="player2nickname" placeholder="JanezekV38#1234" required><br>
						...
						<input type="text" id="player3nickname" name="player3nickname" placeholder="JanezekV38#1234" required><br>
						...
						<input type="text" id="player4nickname" name="player4nickname" placeholder="JanezekV38#1234" required><br>
						...
						<input type="text" id="player5nickname" name="player5nickname" placeholder="JanezekV38#1234" required><br>
						...
						<input type="text" id="player6nickname" name="player6nickname" placeholder="JanezekV38#1234"><br>
						...
						<input type="text" id="player7nickname" name="player7nickname" placeholder="JanezekV38#1234"><br>
