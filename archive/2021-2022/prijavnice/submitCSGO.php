<?php 
    ...
    $subject = "Prijava na SDP Counter Strike: Global Offensive";
    $subject2 = "Prijava na SDP Counter Strike: Global Offensive";
    $message = "Prijava na Counter Strike: Global Offensive:
    ...
    $messagekapetan = "
	Spoštovani,\n
	vaša prijava na Slovensko državno prvenstvo v Counter Strike: Global Offensive je bila uspešno izvedena.
	Za lažjo organizacijo vas prosimo, da se pridružite uradnemu EŠZS Discordu (https://discord.gg/ztMErXem) in se registrirate na FACEIT (https://www.faceit.com/en/championship/db0881ba-19af-408f-8708-e6af451de8a5/Kvalifikacije%20(Q1)%20Rocket%20League%20drzavnega%20prvenstva).
	...
	sdpPrijave::addPlayerCSGO($captain_first_name, $captain_last_name, $from, $captaindiscord, $captainnickname, $captaindrzavljanstvo, $ekipa);
	sdpPrijave::addPlayerCSGO($player2_first_name, $player2_last_name, $player2email, $player2discord, $player2nickname, $player2drzavljanstvo, $ekipa);
	sdpPrijave::addPlayerCSGO($player3_first_name, $player3_last_name, $player3email, $player3discord, $player3nickname, $player3drzavljanstvo, $ekipa);
	sdpPrijave::addPlayerCSGO($player4_first_name, $player4_last_name, $player4email, $player4discord, $player4nickname, $player4drzavljanstvo, $ekipa);
	sdpPrijave::addPlayerCSGO($player5_first_name, $player5_last_name, $player5email, $player5discord, $player5nickname, $player5drzavljanstvo, $ekipa);
	if(!empty($player6_first_name)){
		mail($player6email,$subject2,$messageplayer6,$headers2); // sends a copy of the message to the sender
		sdpPrijave::addPlayerCSGO($player6_first_name, $player6_last_name, $player6email, $player6discord, $player6nickname, $player6drzavljanstvo, $ekipa);
	}
	if(!empty($player7_first_name)){
		mail($player7email,$subject2,$messageplayer7,$headers2); // sends a copy of the message to the sender
		sdpPrijave::addPlayerCSGO($player7_first_name, $player7_last_name, $player7email, $player7discord, $player7nickname, $player7drzavljanstvo, $ekipa);
	}
